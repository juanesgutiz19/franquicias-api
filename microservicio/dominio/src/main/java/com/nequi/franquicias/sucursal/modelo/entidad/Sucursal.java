...
public class Sucursal {
    ...
    private static final String NOMBRE_DE_LA_SUCURSAL_DEBE_TENER_MÍNIMO_4_CARACTERES = "El nombre de la sucursal debe tener mínimo 4 caracteres";
    ...
    public static Sucursal crear(Sucursal sucursal) {
        ...
        validarLongitudMinima(sucursal.getNombre(), LONGITUD_MINIMA_NOMBRE_SUCURSAL, NOMBRE_DE_LA_SUCURSAL_DEBE_TENER_MÍNIMO_4_CARACTERES);
