...
public class ServicioValidarSucursalYProducto {
    ...
    private static final String EL_PRODUCTO_CON_ID_NO_ESTA_ASOCIADO_A_LA_SUCURSAL_CON_ID = "El producto con id %d no está asociado a la sucursal con id %d";
    ...
    public ServicioValidarSucursalYProducto(RepositorioSucursal repositorioSucursal, RepositorioProducto repositorioProducto, RepositorioInventarioSucursal repositorioInventarioSucursal) {
